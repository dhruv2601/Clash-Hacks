...
import datapole.giftest.ui.views.ForcedVideoView;
import datapole.giftest.util.RangeSeekBar;
import datapole.giftest.util.RangeSeekBar.OnRangeSeekBarChangeListener;
...
//        retriever.setDataSource(String.valueOf(MainActivity.MainVidURI));
//
//        String time = retriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_DURATION);
//        long timeInMillisec = Long.parseLong(time);
//        Log.d(TAG,"timeMill: "+timeInMillisec);
...
//                }
    ...
    private void switchToFrameSelector() {
        ...
        try {
            ...
            Log.d(TAG, "start:: " + _seekBar.getSelectedMinValue());
